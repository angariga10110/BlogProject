...
public class AccountService {
	...
	public boolean createAccount(String accountName, String accountEmail, String password,String role) {
		if (accountDao.findByAccountEmail(accountEmail) != null) {
            return false;
        }
		 Account a = new Account(accountName,accountEmail,password, role);
accountDao.save(a);
return true;
}
